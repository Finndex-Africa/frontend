...
const DASHBOARD_URL =
  process.env.NEXT_PUBLIC_DASHBOARD_URL || "http://localhost:3030";
...
export default function Navbar() {
  ...
  const handleLogout = () => {
    ...
    const logoutWindow = window.open(
      `${DASHBOARD_URL}/auth-transfer?logout=true`,
      "_blank",
    );
    setTimeout(() => {
      if (logoutWindow) {
      ...
      <header className="fixed md:sticky top-0 left-0 right-0 z-40 border-b border-gray-100 bg-white/80 backdrop-blur">
        <div className="container-app flex items-center justify-between h-16 px-4">
          ...
          >
            ...
            <div
              className="relative md:hidden shrink-0 overflow-hidden rounded-xl"
            ...
            {!isMounted ? (
              ...
              <div className="relative" ref={menuRef}>
                ...
                >
                  ...
                  <span className="text-white font-medium pr-1">
                    {userName}
                  </span>
                  <svg
        ...
        {showMobileMenu && (
          <div
            ref={mobileMenuRef}
            className="md:hidden border-t border-gray-200 bg-white overflow-y-auto z-50"
