            ...
            <div className="container-app py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
                <div>
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <a href="https://www.linkedin.com/company/finndex-africa/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-700 transition-colors">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                        ...
                        <li><a href="/routes/terms" className="hover:text-gray-900 transition-colors">Terms</a></li>
                    </ul>
                </div>
            </div>
            <div className="container-app py-4 border-t border-gray-300 text-xs text-gray-500">
                © 2026 Finndex Africa. All rights reserved.
            </div>
        </footer>
    );
}
