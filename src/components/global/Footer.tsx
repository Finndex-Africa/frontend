            ...
            <div className="container-app py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
                <div>
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <a href="https://www.youtube.com/@Findafriq" target="_blank" rel="noopener noreferrer" aria-label="FindAfriq on YouTube" className="text-gray-600 hover:text-red-600 transition-colors">
