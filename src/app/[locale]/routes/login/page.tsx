...
// Labels/descriptions live in messages/*.json under auth.userTypes.<value>
const USER_TYPE_VALUES: UserType[] = [
  "HomeSeeker",
  "Agent",
  "RealEstateAgency",
  "Landlord",
          ...
          <div className="flex-1 flex items-center justify-center px-10 pb-10">
            ...
            >
              ...
              <p className="text-lg text-white/90 leading-relaxed">
                {isLogin ? t("heroLogin") : t("heroSignup")}
              </p>

              <div className="mt-10 space-y-4">
                {[
                  { icon: ShieldCheck, key: "perkVerified" },
                  { icon: Home, key: "perkProperties" },
                  { icon: Briefcase, key: "perkServices" },
                ].map(({ icon: Icon, key }) => (
                  <div key={key} className="flex items-center gap-3 text-white/85">
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-blue-900/5 border border-gray-100 p-7 sm:p-9">
              ...
              <div className="text-center mb-7">
                <h2 className="text-2xl font-bold text-gray-900">
                  {isLogin ? t("signInHeading") : t("signUpHeading")}
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label htmlFor="firstName" className="block text-sm font-medium text-gray-700 mb-1.5">
                        {userType === "RealEstateAgency" ? t("agencyName") : t("firstName")}
                      </label>
                      <input
                        id="firstName"
                        name="firstName"
                        ...
                        placeholder={userType === "RealEstateAgency" ? t("agencyNamePlaceholder") : t("firstNamePlaceholder")}
                      />
                    </div>
                    <div>
                      <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 mb-1.5">
                        {userType === "RealEstateAgency" ? t("agencyAdditionalName") : t("lastName")}
                      </label>
                      <input
                        id="lastName"
                        name="lastName"
                        ...
                        className={inputClass.replace("pl-11", "px-4")}
                        placeholder={userType === "RealEstateAgency" ? t("agencyAdditionalNamePlaceholder") : t("lastNamePlaceholder")}
                      />
                    </div>
                  </div>
                )}
                ...
                {!isLogin && (
                  <div>
                    ...
                    {confirmPassword && password !== confirmPassword && (
                      <p className="mt-1.5 text-xs text-red-600">{t("passwordsDoNotMatch")}</p>
                    )}
                  </div>
                )}
                ...
                >
                  {loading ? tCommon("pleaseWait") : isLogin ? t("signIn") : t("signUp")}
                </motion.button>
              </form>
            </div>
