  ...
  const errorMessage = useErrorMessage();
    ...
    const fetchService = async () => {
        try {
            ...
            setError(tErr("form.loadServiceDetails"));
        } finally {
            setLoading(false);
        }
    };
    ...
    const getWhatsAppUrl = () => {
        if (!service) return 'https://wa.me/';
        let phone = '';
        const provider = (service as { providerId?: { phone?: string; whatsapp?: string } }).providerId;
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 px-6 py-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {/* ABOUT SERVICE */}
                    <section>
                        <h2 className="text-lg font-semibold text-gray-900 mb-3">{t("aboutThisService")}</h2>
                        <p className="text-gray-600 text-sm leading-relaxed">
                            {service.description || t("descriptionFallback")}
                        </p>
                    </section>
                    ...
                    {/* MAP SECTION */}
                    <section>
                        <h2 className="text-lg font-semibold text-gray-900 mb-4">{t("serviceCoverage")}</h2>
                    ...
                    <div className="mx-auto max-w-sm lg:flex lg:flex-col lg:h-full">
                                    ...
                                    <div className="p-6 space-y-3 border-t border-gray-100">
                                        {service.status === 'active' ? (
                                            ...
                                            >
                                                ...
                                                <span>{currentUser ? t("requestService") : t("signInToRequest")}</span>
                                        ...
                                        >
                                            ...
                                            <span>{currentUser ? t("whatsappProvider") : t("signInToWhatsApp")}</span>
                                            {!currentUser && <Lock className="w-3.5 h-3.5" />}
                                        </button>
                                    </div>
                            </div>
                        ...
                        {!currentUser ? (
                            <div className="rounded-xl border border-gray-200 bg-white p-6 text-center shadow-lg">
                                            ...
                                            <p className="text-sm font-medium text-gray-900 mb-2">{t("messageTheProvider")}</p>
                                ...
                                >
                                    {submitting ? (
                                        ...
                                        <>
                                            ...
                                            <span>{t("submitServiceRequest")}</span>
                                        </>
                                    )}
                                </button>
                            </div>
