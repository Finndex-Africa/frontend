...
const adaptPropertyToCard = (apiProperty: ApiProperty): Property => {
  ...
  if (apiProperty.bathrooms) {
    amenities.push(
      `${apiProperty.bathrooms} bathroom${apiProperty.bathrooms > 1 ? "s" : ""}`,
    );
  }
  if (apiProperty.area) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] sm:h-[450px] md:h-[400px] w-full overflow-visible pb-32 sm:pb-20 md:pb-0">
        ...
        <div className="relative z-[5] flex flex-col md:block md:h-[400px]">
          <div className="px-4 pt-8 pb-8 sm:pt-10 sm:pb-10 text-center text-white md:absolute md:inset-0 md:flex md:items-center md:justify-center md:pt-0 md:pb-0 md:px-4">
          ...
          <div className="relative z-10 mt-10 sm:mt-12 px-4 pb-6 sm:pb-8 md:mt-0 md:pb-0 md:absolute md:bottom-0 md:left-0 md:right-0 md:translate-y-1/2">
      ...
      <section className="bg-blue-600 py-16 text-white text-center">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto mb-6">
          Whether you&apos;re looking for services or want to provide your
          expertise, we welcome you to be part of our growing community.
        </p>
        <a
          href="/routes/login"
