...
export default function MyServicesPage() {
    ...
    const handleUpdateService = async (values: any, files: File[]) => {
        ...
        try {
            ...
            // Update service
            await servicesApi.update(selectedService._id, {
                ...serviceData,
                                    ...
                                    <div className="flex-1 p-6 sm:p-8">
                                        <div className="flex items-start justify-between mb-4">
                                            ...
                                            <div className="flex items-center gap-2 ml-4">
                                                <span className={`px-3 py-1.5 rounded-full text-xs font-bold ${getStatusColor(service.status)} shadow-sm`}>
                        ...
                        <div className="p-6 sm:p-8 overflow-y-auto max-h-[calc(90vh-140px)]">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(selectedService.status)}`}>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="font-semibold capitalize">{selectedService.category.replace(/_/g, ' ')}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold">{formatCurrency(selectedService.price)}</p>
                                    </div>
                                    <div>
