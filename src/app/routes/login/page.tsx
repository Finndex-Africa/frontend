    ...
    try {
      ...
      if (isLogin) {
        ...
        try {
          ...
          logDebug("Login successful - token stored", {
        ...
        // Client-side navigation keeps DevTools Network history (avoids full reload from window.location).
        console.log("🚀 Redirecting to discover page (client navigation)");
        setLoading(false);
        router.replace("/");
      } else {
            ...
            {!isLogin && (
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Enter WhatsApp number in international format (e.g.,
                  +250788123456)
                </p>
              </div>
            )}
